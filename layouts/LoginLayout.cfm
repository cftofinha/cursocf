...
<head>
	...
	<script>
		var urlSistema = "#event.getHTMLBaseURL()#";
	</script>
...
<body data-spy="scroll" data-target=".navbar" data-offset="50" style="padding-top: 60px">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" role="navigation">
		...
		<a class="navbar-brand mb-0" href="#event.buildLink('')#">
			<strong><i class="fa fa-home"></i> Voltar a Área Pública</strong>
		</a>
	...
	<script src="#event.getHTMLBaseURL()#/assets/js/app.login.js"></script>
</body>
</html>
</cfoutput>
